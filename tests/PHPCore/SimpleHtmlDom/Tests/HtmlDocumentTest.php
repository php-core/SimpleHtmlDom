 ...
 */
class htmlDocumentTest extends BaseTest
{
    ...
    public function dataProvider_for_createElement_should_not_affect_the_dom(): array
    {
        return [
            'empty'  => [''],
            'single' => ['<div></div>'],
            'nested' => ['<table><tr></tr><tr></tr></table>'],
        ];
    }
    ...
    public function dataProvider_for_createTextNode_should_not_affect_the_dom(): array
    {
        return [
            'empty'  => [''],
            'single' => ['<div></div>'],
