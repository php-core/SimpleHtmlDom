 ...
 * Bug tracker
 */
class BugReportTest extends BaseTest
{
	/**
...
HTML;
	 ...
	 *
	 * `HtmlNode::remove()` throws a fatal error:
	 ...
	 * - `HtmlNode::remove()` is called on a node returned by
	 *     `HtmlNode::find()` or `simple_html_dom::find()`
	 *
	 * This error can also happen for `HtmlNode::removeChild()`
	 *
