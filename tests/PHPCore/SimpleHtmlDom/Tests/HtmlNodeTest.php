...
use PHPCore\SimpleHtmlDom\HtmlElement;

/**
 * Tests for HtmlNode
 */
class HtmlNodeTest extends BaseTest
{

	public function rawTextElementProvider(): array
	{
		return [
...
EOD;
	...
	{
		$expected_file = TEST_DATA_PATH . '/simple_html_dom_node/save_file_expected.html';
		$file = TEST_DATA_PATH . '/simple_html_dom_node/save_file.html';
