 ...
 */
class WhitespaceTest extends BaseTest
{
	public function provide_whitespace_around_attributes(): array
	{
		return [
			[
				<<<EOD
...
EOD
	...
	public function provide_whitespace_around_void_tags(): array
	{
		return [
			[
				<<<EOD
...
EOD
	...
	public function provide_whitespace_around_tags(): array
	{
		return [
			[
				<<<EOD
...
EOD
	...
	public function provide_whitespace_around_tags_without_class(): array
	{
		return [
			[
				<<<EOD
...
EOD
	...
	public function provide_whitespace_around_nested_tags(): array
	{
		return [
			[
				<<<EOD
...
EOD
	...
	public function provide_whitespace_in_class_values(): array
	{
		return [
			[
				<<<EOD
...
EOD
	...
	public function provide_whitespace_in_attribute_values(): array
	{
		return [
			[
				<<<EOD
