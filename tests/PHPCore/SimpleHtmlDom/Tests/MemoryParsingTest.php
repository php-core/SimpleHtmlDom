 ...
 */
class memoryParsingTest extends TestCase
{
    /** File for memory tests */
    private string $file = TEST_DATA_PATH.'/memory/index.html';
    ...
    public function setUp(): void
    {
        ...
        $html = new HtmlDocument($contents);
        unset($html);
        $contents = null;
        $file = null;
        gc_collect_cycles();
    ...
    public function test_large_file()
    {
        ...
        $file = TEST_DATA_PATH.'/HTML 5.2.html';
